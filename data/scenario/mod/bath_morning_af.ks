...
[eval exp="f.play=0"]
[cm]
[eval exp="f.wet=0"][eval exp="f.sex_bath='yet'"]

[set_stand][bg time="0" method="crossfade" storage="bg/mod/bg_bath_01.jpg" ]
[f/p_nt][show_stand][syl]
[um_01]Umm?...![p_]
[f/p][name]![lr_]
[f/sp]Chúng ta cùng tắm nhé![p_]
[f/sclp][sm_05]Tắm vào buổi sáng thật sự rất tuyệt đó ạ.[lr_]
[f/ssp]Em sẽ giúp anh kỳ lưng[p_][sm_09]
(...
...
[chara_mod name="dress" time="500" storage="00.png"][wait time="10"]
[chara_mod name="under_b" time="500" storage="00.png" ][wait time="10"]
...
[jump storage="mod/morning_eat_af.ks" target="*lunch"]
[s]
