;;========script_by_ichibikun============
*begin
[eval exp="f.glasses=0"][eval exp="f.ribbon=0"][eval exp="f.hat=0"][eval exp="f.neck=0"][eval exp="f.pin=0"]
[cm][black][chara_00][stop_bgm][bgm_MT][eval exp="f.sex_bal='non'"]
[call target="*set_lag"]
[_](Sáng nay khi thức dậy sớm, tôi không thấy Sylvie bên cạnh.[p]
Tôi thấy có vài tia sáng hắt lại từ hướng ban công,[r] 
có lẽ hôm qua tôi quên đóng cửa sổ.[p]
[chara_mod name="ef2" time="0" storage="H/back/body/door_l_.png" ]
[bg time="1" method="crossfade" storage="H/mod/bal_l.jpg" ]
...
[hide_black]
[layermode graphic="effect/H/bal.png" time="0" mode="normal" wait="false" ]
...[p]
[chara_mod name="ef2" time="800" storage="H/back/body/door_l.png" ]

[random_3][if exp="f.r==1"]
(Tôi thấy Sylvie đang đứng từ ban công nhìn xuống phố với vẻ mặt bình thản..[p]
[elsif exp="f.r==2"]
(Tôi thấy Sylvie đang đứng ở ban công và chăm chú nhìn xuống phố..[p]
[else]
(Tôi thấy Sylvie đang đứng ở ban công và nhìn xuống phố..[p][endif]
Những tia nắng nhẹ của buổi sáng hắt trên áo cô ấy đã thu hút ánh mắt của tôi.[lr]
Tôi lặng lẽ tiến lại gần...[p]
[black][chara_00]
...
*set_lag
[set_black][mod_win st="o/win/LR.png" ]
[if exp="f.dress==21" ][chara_mod name="dress" time="0" storage="H/back/dress/c1_l.png" ]
[elsif exp="f.dress==22" ][chara_mod name="dress" time="0" storage="H/back/dress/c2_l.png" ]
[elsif exp="f.dress==23" ][chara_mod name="dress" time="0" storage="H/back/dress/c3_l.png" ]
[elsif exp="f.dress==24" ][chara_mod name="dress" time="0" storage="H/back/dress/c4_l.png" ]
[elsif exp="f.dress==25" ][chara_mod name="dress" time="0" storage="H/back/dress/c5_l.png" ]
[elsif exp="f.dress==26" ][chara_mod name="dress" time="0" storage="H/back/dress/c6_l.png" ]
[elsif exp="f.dress==27" ][chara_mod name="dress" time="0" storage="H/back/dress/c7_l.png" ]
[elsif exp="f.dress==41" ][chara_mod name="dress" time="0" storage="H/back/dress/e1_l.png" ]
[elsif exp="f.dress==42" ][chara_mod name="dress" time="0" storage="H/back/dress/e2_l.png" ]
[elsif exp="f.dress==43" ][chara_mod name="dress" time="0" storage="H/back/dress/e3_l.png" ]
[elsif exp="f.dress==44" ][chara_mod name="dress" time="0" storage="H/back/dress/e4_l.png" ]
[elsif exp="f.dress==45" ][chara_mod name="dress" time="0" storage="H/back/dress/e5_l.png" ]
[elsif exp="f.dress==46" ][chara_mod name="dress" time="0" storage="H/back/dress/e6_l.png" ][endif]
[chara_mod name="body" time="0" storage="H/back/body/b0_non_l.png" ]
[if exp="f.dress>=21 && f.dress<=30" ]
[chara_mod name="arm" time="0" storage="H/back/body/a0_c_l.png" ][else]
[chara_mod name="arm" time="0" storage="H/back/body/a0_l.png" ][endif]
[chara_mod name="arm_b" time="0" storage="H/back/body/a0__l.png" ]
[chara_mod name="ef2" time="0" storage="00.png" ]
[h_face st="H/back/face/b1_l.png" ]
;;setリボン
[chara_mod name="ribbon" time="0" storage="00.png" ]
;;set/前髪
[if exp="f.front_hair==1" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh1.png" ]
[elsif exp="f.front_hair==2" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh2_l.png" ]
[elsif exp="f.front_hair==3" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh3_l.png" ]
[elsif exp="f.front_hair==4" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh4_l.png" ]
[elsif exp="f.front_hair==5" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh5_l.png" ]
[elsif exp="f.front_hair==6" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh6_l.png" ]
[else][chara_mod name="hair_f" time="0" storage="H/back/body/fh_l.png" ][endif]
...
[elsif exp="f.neck==12" ]
[chara_mod name="neck" time="0" storage="H/back/neck/b2.png" ]
[elsif exp="f.neck==13" ]
[chara_mod name="neck" time="0" storage="H/back/neck/b3.png" ]
[elsif exp="f.neck==14" ]
[chara_mod name="neck" time="0" storage="H/back/neck/b4.png" ]
[endif][return]
...
*show_set
[bg time="1" method="crossfade" storage="H/mod/bal.jpg" ]
...
[layermode graphic="effect/H/bal.png" time="500" mode="normal" wait="true" ]
...[wait time="500"][cm]
...
[_]
[random_3][if exp="f.r==1"]
（Sylvie khẽ giật mình khi tôi chạm vào cô ấy。[p]
[elsif exp="f.r==2"]
(Sylvie hơi giật mình khi tôi tiếp cận cô ấy。[p]
[else]
(Sylvie hơi giật mình khi tôi chạm vào vạt áo của cô ấy。[p][endif]

[syl][na_1]A-Anh đã tỉnh dậy rồi ạ,…。[lr]
[h_face st="H/back/face/a3.png" ]
Em chỉ đang hóng gió ở đây chút thôi ạ...[lr]Em sẽ chuẩn bị bữa sáng cho anh ngay bây giờ ạ.[p]
[h_face st="H/back/face2/a1.png" ]

[_]
[random_3][if exp="f.r==1"]
(Tôi giữ Sylvie lại và nhẹ nhàng vuốt lên vạt áo của cô ấy .[p]
[elsif exp="f.r==2"]
(Tôi giữ Sylvie lại và nhẹ nhàng cảm nhận hơi ấm và sự mềm mại từ vạt áo của cô ấy .[p]
[else]
(Tôi giữ lấy vạt áo của Sylvie và nhẹ nhàng vuốt ve cơ thể cô ấy .[p][endif]
Những tia nắng sớm ấm áp và cơn gió nhẹ thổi qua Sylvie tới tôi[r] 
khiến tâm trí tôi lại trở nên mơ màng...[p]
(Sự yên tĩnh của con phố trong buổi sáng sớm[r] 
và mùi hương thoang thoảng từ Sylvie dường như khiến tôi muốn làm gì đó[r] 
theo bản năng.[p]
...[p]

[syl]
[h_face st="H/back/face/a2.png" ][eh_02]
E-eh!~[r]
A-Anh làm gì vậy?...[p]
[h_face st="H/back/face/a3.png" ][sore_wa_1]
C-chúng ta... đang ở bên ngoài đó...[lr]
[h_face st="H/back/face/a4.png" ]
Mọi người sẽ nhìn thấy mất...[p]
...
[cm]
[_](...[p]
[syl][eval exp="f.sex_door='yet'"]
[eval exp="f.sexless=0"][eval exp="f.sexless_c=0"]
[h_face st="H/back/face/a2.png" ]
N-Nhưng... Em sợ sẽ... không giữ được...yên lặng...[p]
[_](...[p]
[h_face st="H/back/face/a4.png" ]
[random_2][syl]
[if exp="f.r==1"]
Vậy...E-Em sẽ cố gắng giữ yên lặng[lr] 
Anh...chúng ta sẽ chỉ làm một lúc thôi nhé.[p]
[else]
Vậy...E-Em sẽ cố gắng không gây ra tiếng động[lr] 
nhưng...chúng ta sẽ chỉ làm một lúc thôi nhé.[p]
[endif]
[h_face st="H/back/face/a5.png" ]
[_](...[p]
[h_face st="H/back/face/a5.png" ]
(Tôi không thể cưỡng lại cơ thể quyến rũ của Sylvie lúc này.[p]
Cái bộ dạng sợ sệt nhưng có chút mong chờ của cô ấy làm tôi hưng phấn [r]không kiềm chế được.[p] 
Cặp mông nhỏ nhắn và mềm mại của sylvie hơi động nhẹ như muốn khiêu khích tôi.[p]
[h_face st="H/back/face2/a4.png" ][um_01]
(Tôi kéo quần lót của Sylvie xuống khiến cô ấy ngượng ngùng và khẽ run rẩy.[p]
[l_03](Hai tay tôi nhẹ nhàng sờ nắn và mơn trớn mông, eo và đùi của Sylvie[lr]
Cơ thể cô ấy cũng khẽ uốn éo theo và miệng không ngừng tạo thành những tiếng[r] rên ngọt ngào[p]
[h_face st="H/back/face/a2.png" ]
[syl][r2_27]Hah…h![name]...L-làm ơn hãy nhanh lên đi ạ[lr]
[h_body st="H/back/body/uncen/b0.png" ]
(Thằng nhỏ của tôi đã sẵn sàng xâm chiếm Sylvie.[p]
...
(Cô ấy dường như cũng rất phấn khích khi làm tình tại đây.[p]
Mông Sylvie cũng khẽ đẩy theo từng nhịp của tôi và môi âm đạo ẩm ướt của cô ấy cũng[r]
 liên tục khép rồi mở theo nhịp thở như muốn mời gọi tôi.[p]
[h_face st="H/back/face/a2.png" ]
[syl][na_1][name] à! Nếu không nhanh lên sẽ có người thấy chúng ta mất.[p]
[h_face st="H/back/face/a4.png" ]
...
[na_1]Anh đã thỏa mãn rồi nhỉ? [name]. Chúng ta nhanh vào trong thôi.[p]
[h_face st="H/back/face/a2.png" ]
Sẽ rất tệ nếu có ai đó ở dưới phố.[p]
[jump target="*end_"]
...
Sẽ rất tệ nếu ai đó thấy chúng ta..[p]
[random_5]
[if exp="f.r==1"]
[h_face st="H/back/face2/a5.png" ]
[elsif exp="f.r==2"]
...
Cô ấy vẫn còn lo lắng nếu có người nhìn thấy nên âm đạo của cô ấy chưa thực sự chấp nhận tôi.[p][else]
[_](Tôi từ từ thâm nhập vào trong âm đạo ướt át của Sylvie.[lr]
Cô ấy vẫn đang do dự nên âm đạo vẫn chưa nới lỏng và chấp nhận tôi.[p][endif]
[jump target="*choice"]
...
Nữa đi...làm ơn đừng dừng lại như vậy...[p]
...
E-Em sợ sẽ không gữ yên lặng được mất.[p]
[elsif exp="f.r==2" ]
[r_22]Aaah〜 Fuuuu〜♥♥[p]
[elsif exp="f.r==3" ]
...
[elsif exp="f.r==4" ]
[r_04]Un…[p]
Ở ngoài này... dù có chút sợ hãi nhưng...[p][um_01]
[elsif exp="f.r==5" ]
[kya_01]Kuu!…[l] Mọi người sẽ chú ý lên đây mất..[p]
[elsif exp="f.r==6" ]
[r_14] Umm...u! [l]Làm ơn hãy chậm lại...Em sắp...không giữ được...âm thanh...[p]
[elsif exp="f.r==7" ]
E-em…[sex_name][kanjiru_2] cùng [name_h], làm chuyện đó…♥[r]Kết nối với nhau~ ♥♥[p]
Em sẽ... không giữ được...[um_02][p]
[elsif exp="f.r==8" ]
[p_name_ex][chinchin_de_1] của [name_h] đang [l][r_20]…Um…♥[p]
[elsif exp="f.r==9" ]
[name_h][ii_1] cũng… cảm thấy sướng chứ？[l][r_20]…Um…♥[p]
Nếu ai đó bên dưới thấy được chúng ta...em sẽ xấu hổ chết mất...[u_02][p]
[elsif exp="f.r==10" ]
[r_22][r2_02]Ah゛~♥[v_name] Thật tuyệt…♥♥[p]
Chúng ta không nhanh lên sẽ có ai đó bên dưới thấy mất...[p]
[elsif exp="f.r==11" ]
...
[_]
[if exp="f.r==1"]
[l_03](Tôi từ từ khám phá âm đạo ẩm ướt của Sylvie bằng dương vật của mình.[lr]
Cái cảm giác vừa lo lắng vừa hưng phấn này thật kích thích .[p] 
[elsif exp="f.r==2" ]
[l_04](Tôi chậm rãi nhấp dương vật to cứng của mình trong âm đạo ướt át của Sylvie.[lr] 
Cô ấy dường như vẫn do dự vì sợ dưới phố sẽ có người.[p]
[elsif exp="f.r==3" ]
[l_11](Tôi chậm rãi di chuyển hông và đưa dương vật của mình hòa làm một với âm đạo[r] của Sylvie.[p]
Sylyvi khẽ co thắt âm đạo của cô ấy theo từng nhịp thở.[lr]
Dường như cô ấy vẫn lo lắng sẽ có người trông thấy chúng tôi nên hơi gấp gáp.[p] 
[elsif exp="f.r==4"]
...
Tuy nhiên Sylvie lại tỏ ra hơi gấp gáp vì sợ sẽ có người dưới phố.[p]
[elsif exp="f.r==7" ]
...
Sylvie có vẻ hơi hoảng hốt vì sợ không giữ được giọng của mình.[p]

[elsif exp="f.r==11" ]
[l_14]（Sylvie đã ướt, cô ấy dễ dàng chấp nhận dương vật của tôi tiến vào trong[p]
（Hình như tôi không cần quá lo lắng về việc tiến vào trong cô ấy.[p] 

[elsif exp="f.r==12" ]
[l_11](Tôi tiếp tục di chuyển hông một cách nhẹ nhàng đưa dương vật của mình hòa làm một[r] 
với âm đạo của Sylvie.[p]
Sylvie cũng khẽ đẩy mông theo từng nhịp của tôi như muốn kết thúc chuyện này thật nhanh.[p]
...
[if exp="f.r==1"]
[r_23]Ah♥ Aaaaah〜♥♥♥...[name]![p]
Anh nếu không nhanh lên sẽ có người thấy chúng ta mất[p]
[elsif exp="f.r==2" ]
[r_22][r2_02]Ah゛~♥[v_name] Thật tuyệt…♥♥[p]
[elsif exp="f.r==3" ]
[wet_1][wait_sou][p_name_ex] của [name_h][r2_02]~…Ah~…♥♥[p]
...
Em sợ sẽ không giữ được giọng của mình mất.[p]
[elsif exp="f.r==6" ]
...
Sẽ có người thấy chúng ta mất.[p]
[else]
[r2_01]Ah~…[l][manko_de_1][v_name_ex] của em đang…Un♥[p][endif]
...
Sylvie có vẻ khá lo lắng với những tiếng động phát ra.[p]
[elsif exp="f.r==4"]
[l_06](Tôi tiếp tục tăng tốc độ và khám phá âm đạo ẩm ướt của Sylvie bằng[r] dương vật của mình.[p] 
Sylvie vẫn cố gắng giữ giọng của mình không phát ra quá lớn.[p]
[elsif exp="f.r==5" ]
...
Sylvie hơi cúi thấp người xuống như sợ có người trông thấy, đồng thời cũng khiến tôi dễ xâm nhập hơn.[p]
[elsif exp="f.r==8" ]
...
*bat
[cm][black][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
[jump storage="mod/bath_morning_af.ks" target="*begin"]
...
*end_non
[cm]
[stopse][eval exp="f.wet=0"][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
...
Chúng ta nhanh vào ăn sáng thôi ạ.[p]
[else]
[h_face st="H/back/face/a2.png" ]
[syl][eh_01]Eh~?[lr][h_face st="H/back/face/a6.png" ]
Đã xong rồi ư?...[p]
[h_face st="H/back/face/a9.png" ]
[na_1]K-không có gì đâu ạ. Chúng ta nhanh vào ăn sáng thôi ạ...[p]
[endif]
[if exp="f.Hx_dress==0"][eval exp="f.dress=0"][endif][stopbgm]
[button storage="mod/morning_eat_af.ks" target="*lunch" graphic="ch/go_home_lunch.png" x="0" y="200" ]
[button target="*bat" graphic="ch/go_home_bat.png" x="0" y="350" ]
[s]
[jump storage="mod/bath.ks" target="*bath_with"]
[black]
...
*end_
[cm]
[black][stop_bgm][eval exp="f.wet=0"][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
(Thôi, Tạm dừng ở đây vậy.
[if exp="f.Hx_dress==0"][eval exp="f.dress=0"][endif][stopbgm]
[button storage="mod/morning_eat_af.ks" target="*lunch" graphic="ch/go_home_lunch.png" x="0" y="200" ]
[button target="*bat" graphic="ch/go_home_bat.png" x="0" y="350" ]
[s]
...
*end
[cm][stopbgm][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
[button storage="mod/morning_eat_af.ks" target="*lunch" graphic="ch/go_home_lunch.png" x="0" y="200" ]
[button target="*bat" graphic="ch/go_home_bat.png" x="0" y="350" ]
[s]
