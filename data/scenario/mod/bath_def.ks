*begin
[cm][eval exp="f.bath='yet'"][eval exp="f.play=0"]
[if exp="f.hat==1" ][else][eval exp="f.hat=0"][endif]
[if exp="f.love<=1000"]
[jump target="*bath"][endif]
[button target="*bath_with_" graphic="ch/bath_with_.png" x="0" y="200" ]
[button target="*bath" graphic="ch/bath_alone.png" x="0" y="350" ][s]

*bath_with_
[cm][eval exp="f.bath_alone='non'"]
[f/p_nt][a_02]??[lr_]
[f/sp]V-Vâng ạ! Em sẽ giúp [name] kì lưng nữa[p_][sm_09]
[eval exp="f.hair_band=0"][eval exp="f.hair_style=0"]
[eval exp="f.pin=0"][eval exp="f.socks=0" ][eval exp="f.neck=0"][eval exp="f.gloves=0"]
...
[elsif exp="f.dress==5 || f.dress==6"][eval exp="f.dress=5"][eval exp="f.under_b=0"]
[elsif exp="f.dress>=1030 && f.dress<=1049"][jump target="*bath_with"]
[else][eval exp="f.dress=0"]
[endif]
[jump target="*bath_with"]

*bath
[black]
[chara_00]
[eval exp="f.bath_alone='yet'"]
[stopbgm][bgm_JH][cm]
...
[random_20]
;[emb exp="f.r"][p]
[if exp="f.sexless>=2 && f.r>=10 && f.lust>=300"]
[jump target="*bath_lust"]
[elsif exp="f.sexless>=1 && f.r>=11 && f.lust>=300"]
[jump target="*bath_lust"]
[elsif exp="f.sexless>=1 && f.r>=14 && f.lust>=200"]
[jump target="*bath_lust"]
[elsif exp="f.sexless>=1 && f.r>=16 && f.lust>=150"]
[jump target="*bath_lust"]
[elsif exp="f.sexless>=1 && f.r>=17 && f.lust>=100"]
[jump target="*bath_lust"]
[elsif exp="f.sexless>=1 && f.r>=18 && f.lust>=50"]
[jump target="*bath_lust"]
...
*bath_lust
[if exp="f.bath_lust=='yet' && f.m_morning>=1 && f.vgf>=1"][else]
...
[button storage="mod/H/H_bath1_def.ks" target="*begin" graphic="ch/bath_sex.png" x="0" y="350" ][s]


*bath_with
[cm][stopbgm][bgm_JH][black][chara_00][set_stand][f/sp_nt]
...
[if exp="f.bath_alone=='non'"]
[jump target="*bath_next"][endif]
...
[if exp="f.bath_alone=='non'"][jump target="*bathub"][endif]
...
[button storage="mod/H/H_bath2_def.ks" target="*begin" graphic="ch/H_x.png" x="0" y="330" ][endif]
...
*bathub
[cm][black]
[eval exp="f.under_b=0"][eval exp="f.under_p=0"][eval exp="f.dress=0"][eval exp="f.hat=0"]
...
[chara_mod name="eyes" time="0" storage="Hf/body/e_def_nh.png"]
[chara_mod name="mouth" time="0" storage="Hf/body/m_s.png"]
Cả có thể như đang hòa vào làn nước ấm...![lr]
[chara_mod name="eyes" time="0" storage="Hf/body/e_close-.png"]
[chara_mod name="mouth" time="0" storage="Hf/body/m_s.png"]
[chara_mod name="gloves" time="0" storage="mod/bath/b_hand.png"]
Em có cảm giác cơ thể trở nên nhẹ hơn khi ở trong nước...[p]
[chara_mod name="mouth" time="0" storage="Hf/body/m_sn.png"]
[um_09].[wait time="900"].[wait time="900"].[wait time="900"].[wait time="900"].[wait time="900"][um_10][p]
[chara_mod name="mouth" time="0" storage="Hf/body/m_s.png"]
[chara_mod name="eyes" time="0" storage="Hf/body/e_def_nh.png"]
...
[f/sp]Chúng ta ra ngoài uống chút gì nhé![p_]
...
[f/sp_nt][call target="*show_dress"][syl]
[um_10]Umm...[l][f/sclp_nt][name] đã tắm xong rồi à?[p_]
[f/sp_nt]Anh cứ nghỉ một lúc nhé![lr_]
[f/sclp_nt]Em sẽ tắm một lúc ạ[sm_09][p_]
[black](.[wait time="500"].[wait time="500"].[wait time="500"][cm][dress_random][eval exp="f.hair_band=0"][eval exp="f.hair_style=0"][eval exp="f.pin=0"][eval exp="f.socks=0" ][eval exp="f.neck=0"][eval exp="f.gloves=0"][eval exp="f.hat=0"]
