...
[if exp="f.dress_save>=2000 && f.dress_save<=2020" ]
（Cô ấy chỉ mặc mỗi chiếc tạp dề mà không mặc gì bên trong。
[elsif exp="f.dress_save>=1000 && f.dress_save<=1019" ]
（Cô ấy chỉ mặc chiếc váy ngủ mỏng trong suốt gần như không mặc gì。[lr]
[elsif exp="f.dress_save>=1021 && f.dress_save<=1029" ]
（Cô ấy chỉ mặc chiếc váy mỏng trong suốt và không mặc gì bên trong。[lr]
[elsif exp="f.dress_save>=21 && f.dress_save<=49" ]
（Cô ấy đang chuẩn bị bữa sáng cho tôi với một tư thế rất khiêu gợi từ góc nhìn của tôi。[lr]
[elsif exp="f.dress_save==0" ]
...
[_]（Bị mê hoặc bởi sự xuất hiện của Sylvie, tôi tiếp cận từ phía sau cô ấy với sự cương cứng không thể kiểm soát。[p]
